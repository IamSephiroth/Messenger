   ...
   public static void main(String args[]) {
      ...
      try {
         ...
         String schema2 = "INSERT INTO MESSAGES (ID,RECEIVER_ID,MESSAGE,DATE) "
            + "VALUES ('Johnny1984', 'CosmoW2010', 'Hello Cosmo!', '12/10/98' );";
         stmt.executeUpdate(schema2);

         schema2 = "INSERT INTO MESSAGES (ID,RECEIVER_ID,MESSAGE,DATE) "
            + "VALUES ('EllieW1998', 'JaneS!1977', 'I am working on my java today', '12/10/98' );";
         stmt.executeUpdate(schema2);

         schema2 = "INSERT INTO MESSAGES (ID,RECEIVER_ID,MESSAGE,DATE) "
                 + "VALUES ('CosmoW2010', 'EllieW1998', 'pls let me in, I am cold', '12/10/98' );";
              stmt.executeUpdate(schema2);


              schema2 = "INSERT INTO MESSAGES (ID,RECEIVER_ID,MESSAGE,DATE) "
                      + "VALUES ('JaneS!1977', 'EllieW1998', 'How was your day?', '12/10/98' );";
                   stmt.executeUpdate(schema2);
